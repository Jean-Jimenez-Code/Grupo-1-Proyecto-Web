...
router.post('/', function(req, res, _) {
  ...
  if(suma1 >0 ||suma2>0 || suma3 >0 ||suma4>0 ||suma5>0||suma6>0||suma7>0||suma8>0||suma9>0||suma10>0||suma11>0){//ver si alguna cantidad es mayor a 0
      ...
      st=st +suma10*4990
      st=st +suma11*1490
      st=palabra +st //para que la palabra en la variable palabra quede junto con el valor de st
    }
  else{
    st=palabra + 0
  }
